 ...
 */
function test_anchor_resolution(shorthand, peak_val) {
...
exports.test_anchor_resolution = test_anchor_resolution;
...
const wasmPath = `${__dirname}/mv2_wasm_bg.wasm`;
